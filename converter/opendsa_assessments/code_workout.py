...
class CodeWorkoutExercises(object):
    def __init__(self, guides_dir, generate_dir, exercises):
        self._guides_dir = guides_dir
        self._generate_dir = generate_dir
        self._exercises = exercises

    def create_assessments_data(self):
        if not self._exercises:
            return
        logging.debug("process create odsa test assessments content")
        odsa_private_ex_dir = self._guides_dir.joinpath("secure/assessments")
        ...
        for exercise in self._exercises:
            ...
            starter_code_dir = self._generate_dir.joinpath(f'exercises/{group_name}/{file_name}')
            ...
            tester_code = self.get_tester_code(exercise_data)
